...
const BigInputSearchWrapper = ComponentName => styled(ComponentName)`
  &.ant-input-affix-wrapper {
    .ant-input {
      padding: 4px 10px;
      width: 100%;
...
export { BigInputWrapper, InputWrapper, InputGroupWrapper, BigInputSearchWrapper, InputSearchWrapper, TextAreaWrapper };
