...
const WDTodoListWrapper = styled.div`
  ...
  .isoTodoListWrapper {
    ...
    .isoTodoList {
      width: 100%;
      padding: ${props =>
        props['data-rtl'] === 'rtl' ? '20px 20px 20px 15px' : '20px 15px 20px 20px'};
      overflow: hidden;
      margin: 0 0 15px;
      background: #ffffff;
      border: 1px solid ${palette('border', 0)};
...
`;
const ReviewWrapper = WithDirection(WDTodoWrapper);
const ReviewListWrapper = WithDirection(WDTodoListWrapper);
export { ReviewWrapper, ReviewListWrapper };
