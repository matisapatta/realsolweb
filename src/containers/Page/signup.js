...
class SignUp extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.user.register)
      ...
      if (nextProps.user.users.code === 11000) {
        notification('error', "Error al registrar, ya existe un usuario registrado con esa dirección de email")
      }
      else {
        notification('error', "Ocurrió un error inesperado, por favor vuelva a intentar más tarde")
      }
